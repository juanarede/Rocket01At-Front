...
>
      ...
      <Sidebar
        ...
        extraContent={
          <button
            type="button"
            className="text-white bg-gradient-to-r from-[#ffcc29] to-[#ff7b54] hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-white font-medium rounded-lg text-3xl px-5 py-2.5 text-center w-full zuume-font"
            style={{
